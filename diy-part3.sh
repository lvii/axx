...
mv diy/bg/logo.png oopenwrt/package/lean/luci-theme-argon_armygreen/htdocs/luci-static/argon_armygreen/logo.png
...
mv diy/bg/bg1.jpg openwrt/package/feeds/kenzo/luci-theme-argonne/htdocs/luci-static/argonne/img
#------------------------------------------------------------------------------------------------------------------------
