...
sed -i "s/OpenWrt /AutoBuild https://github.com/MuaCat/Actions-OpenWrt.git $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" package/lean/default-settings/files/zzz-default-settings
